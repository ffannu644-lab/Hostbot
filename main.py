...
# --- Configuration ---
TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '7667215328:AAHH1yKRalfLmXMXnw43dpPVaQuj_Na3xYc')
OWNER_ID = int(os.getenv('OWNER_ID', '8214037239'))
ADMIN_ID = int(os.getenv('ADMIN_ID', '8214037239'))
YOUR_USERNAME = os.getenv('BOT_USERNAME', '@zerotrace_8')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'https://t.me/freefireofcchannel_7')
